...
<template>
    <AuthBase
        ...
        description="Enter your email and password below to log in or Login via Atlassian"
    >
        <Head title="Log in" />
        ...
        >
            ...
            <div class="grid gap-6">
                ...
                <div v-if="$page.props.errors.social_login" class="text-red-500 text-sm mt-2">
                {{ $page.props.errors.social_login }}
                </div>
            </div>
