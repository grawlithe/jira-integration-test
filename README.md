...
```
cd existing_repo
git remote add origin http://git.prxag.de/mct-net/import_time_spent_from_jira.git
git branch -M main
...
- [ ] [Set up project integrations](http://git.prxag.de/mct-net/import_time_spent_from_jira/-/settings/integrations)
